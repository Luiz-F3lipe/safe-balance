    ...
    @if($category)
        <div class="py-4">
            <div class="flex items-center gap-3 mb-4">
                ...
                <div>
                    <p class="text-lg font-medium">Excluir Categoria</p>
                    <p class="text-gray-600">Tem certeza que deseja excluir a categoria "{{ $category->description }}"?</p>
                </div>
            </div>
            ...
            <div class="bg-red-50 dark:bg-red-900/20 rounded-lg p-3 border border-red-200 dark:border-red-800">
                <p class="text-sm text-red-800 dark:text-red-200">
                    ...
                    Esta ação é permanente e não poderá ser desfeita. Todos os dados desta categoria serão removidos do sistema.
                </p>
            </div>
        ...
        <x-slot:actions>
            ...
            <x-button label="Excluir Categoria" wire:click="destroy" spinner="destroy"
