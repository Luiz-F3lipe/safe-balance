    ...
    @if($transaction)
        <div class="py-4">
            <div class="flex items-center gap-3 mb-4">
                ...
                <div>
                    <p class="text-lg font-medium">Excluir Transação</p>
                    <p class="text-gray-600">Tem certeza que deseja excluir a transação "{{ $transaction->description }}"?</p>
                </div>
            </div>
            ...
            <div class="bg-red-50 dark:bg-red-900/20 rounded-lg p-3 border border-red-200 dark:border-red-800">
                <p class="text-sm text-red-800 dark:text-red-200">
                    ...
                    Esta ação é permanente e não poderá ser desfeita. Todos os dados desta transação serão removidos do sistema.
                </p>
            </div>
            ...
            <div class="mt-4 bg-gray-50 dark:bg-gray-800 rounded-lg p-3">
                <p class="text-sm text-gray-700 dark:text-gray-300">
                    ...
                    Nome: {{ $transaction->description }}<br>
                    Valor: R$ {{ number_format($transaction->amount, 2, ',', '.') }}<br>
                    Parcelas: {{ $transaction->installments }}<br>
        ...
        <x-slot:actions>
            ...
            <x-button label="Excluir Transação" wire:click="destroy" spinner="destroy"
