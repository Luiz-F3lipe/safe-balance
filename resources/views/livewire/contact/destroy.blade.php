    ...
    @if($contact)
        <div class="py-4">
            <div class="flex items-center gap-3 mb-4">
                ...
                <div>
                    <p class="text-lg font-medium">Excluir Contato</p>
                    <p class="text-gray-600">Tem certeza que deseja excluir o contato "{{ $contact->name }}"?</p>
                </div>
            </div>
            ...
            <div class="bg-red-50 dark:bg-red-900/20 rounded-lg p-3 border border-red-200 dark:border-red-800">
                <p class="text-sm text-red-800 dark:text-red-200">
                    ...
                    Esta ação é permanente e não poderá ser desfeita. Todos os dados deste contato serão removidos do sistema.
                </p>
            </div>
        ...
        <x-slot:actions>
            ...
            <x-button label="Excluir Contato" wire:click="destroy" spinner="destroy"
